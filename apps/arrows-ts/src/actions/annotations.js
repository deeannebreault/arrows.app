import {createTextAnnotation as createTextAnnotationModel, createDrawingAnnotation as createDrawingAnnotationModel} from "../model/Annotation"
...
export const createTextAnnotation = (position, text = '') => (dispatch, getState) => {
  ...
  dispatch({
    ...
    annotation: createTextAnnotationModel(
...
export const createDrawingAnnotation = () => (dispatch, getState) => {
  ...
  dispatch({
    ...
    annotation: createDrawingAnnotationModel(
      nextAvailableId(annotations),
      []
    )
  })
